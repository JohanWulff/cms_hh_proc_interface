...
int main(int argc, char *argv[]) {
    ...
    float b_1_csvl(csv(rng)), b_2_csvl(csv(rng)), vbf_1_csvl(csv(rng)), vbf_2_csvl(csv(rng));
    float b_1_csvb(csv(rng)), b_2_csvb(csv(rng)), vbf_1_csvb(csv(rng)), vbf_2_csvb(csv(rng));
