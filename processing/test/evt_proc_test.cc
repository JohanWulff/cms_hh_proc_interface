...
int main(int argc, char *argv[]) {
    ...
    std::map<std::string, float> feats = evt_proc.process(b_1, b_2, l_1, l_2, met, sv, vbf_1, vbf_2, hh_kinfit_mass, hh_kinfit_chi2, mt2, 
                                                          is_boosted, csv_1, csv_2, channel, year, res_mass, spin, klambda, 1, true, false,
    ...
    std::vector<float> vec = evt_proc2.process_as_vec(b_1, b_2, l_1, l_2, met, sv, vbf_1, vbf_2, hh_kinfit_mass, hh_kinfit_chi2, mt2, is_boosted, csv_1, csv_2,
                                                      channel, year, res_mass, spin, klambda, 2, false, true, b_1_hhbtag, b_2_hhbtag, vbf_1_hhbtag, vbf_2_hhbtag,
                                                      b_1_cvsl, b_2_cvsl, vbf_1_cvsl, vbf_2_cvsl, b_1_cvsb, b_2_cvsb, vbf_1_cvsb, vbf_2_cvsb, cv, c2v, c3,
                                                      true);
    std::cout << "Processed\n";
    ...
    evt_proc2.process_to_vec(feat_vals, b_1, b_2, l_1, l_2, met, sv, vbf_1, vbf_2, hh_kinfit_mass, hh_kinfit_chi2, mt2, is_boosted, csv_1, csv_2, channel, year,
                             res_mass, spin, klambda, 3, false, false, b_1_hhbtag, b_2_hhbtag, vbf_1_hhbtag, vbf_2_hhbtag,
                             b_1_cvsl, b_2_cvsl, vbf_1_cvsl, vbf_2_cvsl, b_1_cvsb, b_2_cvsb, vbf_1_cvsb, vbf_2_cvsb, cv, c2v, c3,
                             true);
